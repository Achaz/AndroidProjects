...
package com.nemah.net.materialmenu;
...
import static com.nemah.net.materialmenu.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.nemah.net.materialmenu.MaterialMenuDrawable.DEFAULT_PRESSED_DURATION;
import static com.nemah.net.materialmenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.nemah.net.materialmenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.nemah.net.materialmenu.MaterialMenuDrawable.IconState;
import static com.nemah.net.materialmenu.MaterialMenuDrawable.Stroke;
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, com.nemah.net.R.styleable.MaterialMenuView);
